...
(() => {
    ...
    const $ = {
        ...
        updateSlides: function () {
                    ...
                    c[n] && (c[n].swiperSlideSize = E),
                        ...
                        i.centeredSlides
                            ? ((T = T + E / 2 + y / 2 + b),
                              ...
                              h.push(T))
                            : (i.roundLengths && (T = Math.floor(T)), (S - Math.min(e.params.slidesPerGroupSkip, S)) % e.params.slidesPerGroup == 0 && u.push(T), h.push(T), (T = T + E + b)),
                        (e.virtualSize += E + b),
                        (y = E),
                        (S += 1);
                }
            ...
            if (
                ...
                r && l && ("slide" === i.effect || "coverflow" === i.effect) && n.css({ width: `${e.virtualSize + i.spaceBetween}px` }),
    ...
    const I = {
        slideTo: function (e = 0, t = this.params.speed, s = !0, i, n) {
            ...
            let w;
            if (((w = r > p ? "next" : r < p ? "prev" : "reset"), (u && -v === a.translate) || (!u && v === a.translate)))
                return a.updateActiveIndex(r), l.autoHeight && a.updateAutoHeight(), a.updateSlidesClasses(), "slide" !== l.effect && a.setTranslate(v), "reset" !== w && (a.transitionStart(s, w), a.transitionEnd(s, w)), !1;
            if (l.cssMode) {
                const e = a.isHorizontal(),
                    s = u ? v : -v;
                if (0 === t) {
    ...
    function D(e) {
        ...
        if (!s.allowTouchMove) return (s.allowClick = !1), void (i.isTouched && (Object.assign(r, { startX: p, startY: u, currentX: p, currentY: u }), (i.touchStartTime = g())));
        ...
        if (void 0 === i.isScrolling) {
            ...
            (s.isHorizontal() && r.currentY === r.startY) || (s.isVertical() && r.currentX === r.startX)
                ? (i.isScrolling = !1)
                : h * h + m * m >= 25 && ((e = (180 * Math.atan2(Math.abs(m), Math.abs(h))) / Math.PI), (i.isScrolling = s.isHorizontal() ? e > a.touchAngle : 90 - e > a.touchAngle));
        }
        ...
        if (
            ...
            v > 0 && i.currentTranslate > s.minTranslate()
                ? ((w = !1), a.resistance && (i.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + i.startTranslate + v) ** b))
                : v < 0 && i.currentTranslate < s.maxTranslate() && ((w = !1), a.resistance && (i.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - i.startTranslate - v) ** b)),
        ...
        if (c > i.longSwipesMs) {
            ...
            t.navigation && (o.target === t.navigation.nextEl || o.target === t.navigation.prevEl)
                ? o.target === t.navigation.nextEl
                    ? t.slideTo(u + v)
                    : t.slideTo(u)
                : ("next" === t.swipeDirection && t.slideTo(u + v), "prev" === t.swipeDirection && t.slideTo(u));
        }
    }
    function B() {
        const e = this,
    ...
    class J {
        constructor(...e) {
            ...
            const n = {};
            i.modules.forEach((e) => {
                e({ swiper: i, extendParams: X(s, n), on: i.on.bind(i), once: i.once.bind(i), off: i.off.bind(i), emit: i.emit.bind(i) });
            });
            const a = b({}, Y, n);
            return (
                (i.params = b({}, a, K, s)),
    ...
    function ne(e, t) {
        if (document.querySelector(e)) new Q(e, ie({ disableOnInteraction: !0, pauseOnMouseEnter: !0, keyboard: { enabled: !0, onlyInViewport: !1 }, navigation: !0 }, t));
    }
    function ae(e) {
        ...
        s &&
            ("both" === t
                ? ((s.style.paddingLeft = "".concat(n, "px")), (s.style.paddingRight = "".concat(n, "px")))
                : "left" === t
    ...
    Q.use([
        function ({ swiper: e, extendParams: t, on: s, emit: i }) {
            ...
            function d() {
                ...
                if (((e.params.navigation = Z(e, e.originalParams.navigation, e.params.navigation, { nextEl: "swiper-button-next", prevEl: "swiper-button-prev" })), !t.nextEl && !t.prevEl)) return;
                const s = n(t.nextEl),
                    i = n(t.prevEl);
        ...
        function ({ swiper: e, extendParams: t, on: s, emit: i }) {
                ...
                if (
                    ...
                    if (
                        (s.dynamicBullets &&
                            ...
                            s.dynamicMainBullets > 1 && void 0 !== e.previousIndex && ((r += c - (e.previousIndex - e.loopedSlides || 0)), r > s.dynamicMainBullets - 1 ? (r = s.dynamicMainBullets - 1) : r < 0 && (r = 0)),
                            (n = Math.max(c - r, 0)),
            ...
            function p() {
                ...
                let s = f(t.el);
                0 !== s.length &&
                    (e.params.uniqueNavElements && "string" == typeof t.el && s.length > 1 && ((s = e.$el.find(t.el)), s.length > 1 && (s = s.filter((t) => f(t).parents(".swiper")[0] === e.el))),
                    "bullets" === t.type && t.clickable && s.addClass(t.clickableClass),
                    s.addClass(t.modifierClass + t.type),
                    s.addClass(t.modifierClass + e.params.direction),
                    "bullets" === t.type && t.dynamicBullets && (s.addClass(`${t.modifierClass}${t.type}-dynamic`), (r = 0), t.dynamicMainBullets < 1 && (t.dynamicMainBullets = 1)),
        ...
        function ({ swiper: e, extendParams: t, on: s }) {
            t({ fadeEffect: { crossFade: !1, transformEl: null } }),
                (function (e) {
                    const { effect: t, swiper: s, on: i, setTranslate: n, setTransition: a, overwriteParams: r, perspective: l } = e;
                    i("beforeInit", () => {
                    ...
                    setTranslate: () => {
                        ...
                        for (let i = 0; i < t.length; i += 1) {
                            ...
                            te(s, t).css({ opacity: r }).transform(`translate3d(${n}px, ${a}px, 0px)`);
                        }
                    },
                    setTransition: (t) => {
        ...
        function ({ swiper: e, extendParams: t, on: s }) {
            ...
            function l(t) {
                ...
                if (e.realIndex !== s.realIndex || a) {
                    ...
                    a && (r += "next" === l ? n : -1 * n),
                        s.visibleSlidesIndexes &&
                            ...
                            (s.params.centeredSlides ? (r = r > o ? r - Math.floor(i / 2) + 1 : r + Math.floor(i / 2) - 1) : r > o && s.params.slidesPerGroup, s.slideTo(r, t ? 0 : void 0));
                }
                let r = 1;
                ...
                else for (let t = 0; t < r; t += 1) s.slides.eq(e.realIndex + t).addClass(l);
            }
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        window.addEventListener("resize", le),
            le(),
            ne(".hero_slider", { slidesPerView: 1, loop: !0, autoplay: !0, speed: 800, effect: "fade", fadeEffect: { crossFade: !0 }, pagination: { el: ".hero-pagination", clickable: !0 }, navigation: { nextEl: ".swiper-button-next", prevEl: ".swiper-button-prev" } }),
            ne(".featured_products-slider", { slidesPerView: 1, spaceBetween: 20, loop: true, autoplay: true, speed: 800, navigation: { nextEl: ".featured_products-slider .swiper-button-next", prevEl: ".featured_products-slider .swiper-button-prev" }, pagination: { el: ".featured_products-slider .swiper-pagination", clickable: true }, breakpoints: { 576: { slidesPerView: 2, spaceBetween: 20 }, 768: { slidesPerView: 3, spaceBetween: 20 }, 992: { slidesPerView: 4, spaceBetween: 20 } } }),
            (e = ".hero-pagination"),
            document.querySelectorAll("".concat(e, " .swiper-pagination-bullet")).forEach(function (e, t) {
            ...
            ne(".reviews_slider", {
                ...
                speed: 1500,
                spaceBetween: 30,
                breakpoints: { 768: { slidesPerView: 2, spaceBetween: 20 }, 992: { slidesPerView: 2, spaceBetween: 30 }, 1200: { slidesPerView: 3 } },
                pagination: { el: ".swiper-pagination", clickable: !0 },
            }),
            ne(".partners_list", { slidesPerView: 1, loop: !0, autoplay: !0, speed: 1e3, breakpoints: { 576: { slidesPerView: 2 }, 768: { slidesPerView: 3 }, 992: { slidesPerView: 4 }, 1200: { slidesPerView: 5, autoplay: !1 } } }),
            ne(".popular_slider", {
                slidesPerView: 1,
                loop: !0,
                spaceBetween: 30,
                autoplay: !0,
                speed: 1e3,
                breakpoints: { 576: { slidesPerView: 2 }, 992: { slidesPerView: 3, spaceBetween: 40 }, 1200: { slidesPerView: 4 } },
                pagination: { el: ".swiper-pagination", clickable: !0 },
            }),
            re();
    });
    ...
    const dropdownSubmenuItems = document.querySelectorAll('.dropdown-submenu > a');
        ...
        item.addEventListener('click', function(e) {
            ...
            if (isMobile) {
                ...
                if (submenu.classList.contains('active')) {
                    ...
                    const siblingItems = this.parentElement.parentElement.querySelectorAll('.dropdown-submenu > ul');
                    siblingItems.forEach(menu => {
                        if (menu !== submenu) {
    ...
    document.addEventListener('click', function(e) {
        if (!e.target.closest('.dropdown-submenu')) {
            const openSubmenus = document.querySelectorAll('.dropdown-submenu > ul.active');
    ...
    window.addEventListener('resize', function() {
        if (window.innerWidth >= 1200) {
            // Reset all mobile-specific styles when returning to desktop
            document.querySelectorAll('.dropdown-submenu > ul').forEach(menu => {
                menu.style.display = '';
            });
        }
    });
